...
for (let i = 0; i < existingContacts.length; i++) {
        myTable += '<tr>';
        myTable += '<td><a href="file:///Users/Dimitri/Documents/GitHub/dimitri-bariamis-1/contact_manager_dataBase/view/index.html?index=' + i + '"</a>' + existingContacts[i].firstName + '</td>';
